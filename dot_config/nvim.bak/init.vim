...
let g:coc_global_extensions = ['coc-json', 'coc-css', 'coc-html', 'coc-prettier', 'coc-tsserver', 'coc-styled-components', 'coc-react-refactor', 'coc-explorer', 'coc-rust-analyzer']
